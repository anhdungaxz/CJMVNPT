...
@interface CJM(ProductConfig)
@property (atomic, strong, readonly, nonnull) CJMProductConfig *productConfig;
@end


#pragma mark - CleverTapConfigValue

@interface CJMConfigValue : NSObject <NSCopying>
...
@interface CJMProductConfig : NSObject
