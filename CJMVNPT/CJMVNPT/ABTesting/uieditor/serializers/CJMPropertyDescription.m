...
@implementation CJMPropertySelectorParameterDescription
...
@implementation CJMPropertySelectorDescription
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    ...
    if (self) {
        ...
        for (NSDictionary *parameter in dictionary[@"parameters"]) {
            [parameters addObject:[[CJMPropertySelectorParameterDescription alloc] initWithDictionary:parameter]];
        }
...
@interface CJMPropertyDescription ()

@property (nonatomic, readonly) NSPredicate *predicate;

@end

@implementation CJMPropertyDescription
...
- (instancetype)initWithDictionary:(NSDictionary *)dictionary {
    ...
    if (self) {
        ...
        _getSelectorDescription = [[CJMPropertySelectorDescription alloc] initWithDictionary:get];
        if (set) {
            _setSelectorDescription = [[CJMPropertySelectorDescription alloc] initWithDictionary:set];
        } else {
            _readonly = YES;
        }
