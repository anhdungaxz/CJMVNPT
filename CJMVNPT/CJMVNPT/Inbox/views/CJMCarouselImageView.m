...
@interface CJMCarouselImageView ()
...
@implementation CJMCarouselImageView
...
- (void)setup {
    ...
    self.captionLabel.textColor = [CJMInAppUtils CJM_colorWithHexString:self.captionColor];
    ...
    self.subcaptionLabel.textColor = [CJMInAppUtils CJM_colorWithHexString:self.subcaptionColor];
