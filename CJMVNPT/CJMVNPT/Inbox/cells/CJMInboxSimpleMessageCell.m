...
@implementation CJMInboxSimpleMessageCell
...
- (void)doLayoutForMessage:(CJMInboxMessage *)message {
    ...
    CJMInboxMessageContent *content = message.content[0];
    ...
    self.titleLabel.textColor = [CJMInAppUtils CJM_colorWithHexString:content.titleColor];
    self.bodyLabel.textColor = [CJMInAppUtils CJM_colorWithHexString:content.messageColor];
    self.dateLabel.textColor = [CJMInAppUtils CJM_colorWithHexString:content.titleColor];
    [self layoutSubviews];
    [self layoutIfNeeded];
}
