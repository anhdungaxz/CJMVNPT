...
#import "CJMKnownProfileFields.h"
...
@implementation CJMProfileBuilder

+ (void)build:(NSDictionary *)profile completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields, NSDictionary* _Nullable systemFields, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    ...
    @try {
        ...
        for (int i = 0; i < [profileAllKeys count]; i++) {
            ...
            if ([vr object] == nil || [((NSString *) [vr object]) isEqualToString:@""]) {
                [errors addObject:[CJMValidationResult resultWithErrorCode:512 andMessage:[NSString stringWithFormat:@"Invalid user profile key: %@", key]]];
                CJMLogStaticDebug(@"Invalid user profile key: %@", key);
                continue;
            }
            ...
            BOOL accepted = false;
            @try {
                vr = [CJMValidator cleanObjectValue:value context:CJMValidatorContextProfile];
            ...
            if ([vr errorCode] != 0) {
                [errors addObject:vr];
                if ([vr errorDesc] != nil) {
                    CJMLogStaticDebug(@"%@: %@", self, [vr errorDesc]);
                }
            }            
            // if a reserved key add to systemFields else add to customFields
            KnownField kf = [CJMKnownProfileFields getKnownFieldIfPossibleForKey:key];
            if (kf != UNKNOWN) {
                systemFields[[CJMKnownProfileFields getStorageValueForField:kf]] = value;
            } else {
        ...
        CJMLogStaticInternal(@"%@: error building profile: %@", self, e.debugDescription);
        completion(nil, nil, errors);
    }
}

+ (void)buildGraphUser:(id)graphUser completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields, NSDictionary* _Nullable systemFields, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    NSMutableArray<CJMValidationResult*> *errors = [NSMutableArray new];
    @try {
        ...
        if (name) {
            @try {
                CJMValidationResult *vr = [CJMValidator cleanObjectValue:name context:CJMValidatorContextProfile];
        ...
        if (gender) {
            if ([CJMUtils doesString:gender.lowercaseString startWith:@"m"])
                gender = @"M";
            else if ([CJMUtils doesString:gender.lowercaseString startWith:@"f"])
                gender = @"F";
            else
                gender = @"";
        }
        ...
        CJMLogStaticDebug(@"%@: Error building a FB profile update: %@", self, e.debugDescription);
        completion(nil, nil, errors);
    }
}

+ (void)buildGooglePlusUser:(id)googleUser completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields, NSDictionary* _Nullable systemFields, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    NSMutableArray<CJMValidationResult*> *errors = [NSMutableArray new];
    @try {
        if (googleUser == nil) {
            completion(nil, nil, errors);
        ...
        if (name) {
            @try {
                ...
                if (vr.object && [[vr object] isKindOfClass:[NSString class]]) {
                    if ([vr object] == nil || [((NSString *) [vr object]) isEqualToString:@""]) {
                        [errors addObject:vr];
                        CJMLogStaticDebug(@"%@: Invalid Google Plus user name: %@", self, name);
                        completion(nil, nil, errors);
                        return;
                    }
                }
        ...
        // We won't get here
        CJMLogStaticDebug(@"Creating Google+ profile update event failed: %@", e);
        completion(nil, nil, errors);
    }
}

+ (void)buildRemoveValueForKey:(NSString *)key completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields, NSDictionary* _Nullable systemFields, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    NSMutableArray<CJMValidationResult*> *errors = [NSMutableArray new];
    CJMValidationResult *vr;
    vr = [CJMValidator cleanObjectKey:key];
    if ([vr object] == nil || [((NSString *) [vr object]) isEqualToString:@""]) {
        [errors addObject:[CJMValidationResult resultWithErrorCode:512 andMessage:[NSString stringWithFormat:@"Invalid profile value for %@", key]]];
        CJMLogStaticDebug(@"Invalid user profile key: %@", key);
        completion(nil, nil, errors);
        return;
    }
...
+ (void)buildSetMultiValues:(NSArray<NSString *> *)values forKey:(NSString *)key localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
...
+ (void)buildAddMultiValue:(NSString *)value forKey:(NSString *)key localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
...
+ (void)buildAddMultiValues:(NSArray<NSString *> *)values forKey:(NSString *)key localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
...
+ (void)buildRemoveMultiValue:(NSString *)value forKey:(NSString *)key localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    if (value == nil || [value isEqualToString:@""]) {
        NSMutableArray<CJMValidationResult*> *errors = [NSMutableArray new];
        [errors addObject:[self _generateEmptyMultiValueErrorForKey:key]];
        completion(nil, nil, errors);
...
+ (void)buildRemoveMultiValues:(NSArray *)values forKey:(NSString *)key localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
...
+ (CJMValidationResult*)_generateEmptyMultiValueErrorForKey:(NSString *)key {
    return [self _generateInvalidMultiValueError:[NSString stringWithFormat:@"Empty multi-value property value for key %@", key]];
}

+ (CJMValidationResult*)_generateInvalidMultiValueKeyErrorForKey:(NSString *)key {
    return [self _generateInvalidMultiValueError:[NSString stringWithFormat:@"Invalid multi-value property key %@", key]];
}

+ (CJMValidationResult*) _generateInvalidMultiValueError:(NSString *)message {
    return [CJMValidationResult resultWithErrorCode:512 andMessage:message];
    CJMLogStaticDebug(@"%@: %@", self, message);
}

+ (void)_handleMultiValues:(NSArray<NSString *> *)values forKey:(NSString *)key withCommand:(NSString *)command localDataStore:(CJMLocalDataStore*)dataStore completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion  {
    NSMutableArray<CJMValidationResult*> *errors = [NSMutableArray new];
    if (key == nil) {
        completion(nil, nil, errors);
        return;
    ...
    @try {
        CJMValidationResult *vr;
        // validate key
        vr = [CJMValidator cleanMultiValuePropertyKey:key];
        // Check for an error
        if ([vr errorCode] != 0) {
            [errors addObject:vr];
            if ([vr errorDesc] != nil) {
        ...
        CJMLogStaticInternal(@"%@: error in _handleMultiValues forKey: %@ Reason: %@", self, key, e.debugDescription);
        completion(nil, nil, errors);
    }
}

+ (NSArray<NSString *> *) _constructLocalMultiValueWithOriginalValues:(NSArray *)values forKey:(NSString *)key usingCommand:(NSString *)command localDataStore:(CJMLocalDataStore*)dataStore {
    if (!command || ![CLTAP_MULTIVAL_COMMANDS containsObject:command]) {
        CJMLogStaticInternal(@"%@: Unknown multi-value command %@, aborting", self, command);
        return nil;
    }
    CJMValidationResult *vr;
    ...
    for (__strong NSString *value in values) {
        @try {
            vr = [CJMValidator cleanMultiValuePropertyValue:value];
            if ([vr errorCode] != 0) {
                if ([vr errorDesc] != nil) {
                    CJMLogStaticDebug(@"%@: %@", self, [vr errorDesc]);
                }
            ...
            CJMLogStaticInternal(@"%@: error %@ when adding value %@ to multi-value property for key %@", self, e.debugDescription, value, key);
            return nil;
        }
    }
    return multiValue;
...
+ (NSArray<NSString *> *) _constructExistingMultiValueForKey:(NSString *)key usingCommand:(NSString *)command localDataStore:(CJMLocalDataStore*)dataStore {
    BOOL remove = [command isEqualToString:kCLTAP_COMMAND_REMOVE];
    BOOL add = [command isEqualToString:kCLTAP_COMMAND_ADD];
...
+ (NSString *)_stringifyAndCleanScalarProfilePropValue:(id)value {
    ...
    if (ret) {
        @try {
            CJMValidationResult *vr = [CJMValidator cleanMultiValuePropertyValue:ret];
...
+ (void)_validateAndPushMultiValue:(NSArray<NSString *> *)multiValue forKey:(NSString *)key withOriginalValues:(NSArray<NSString *> *)values usingCommand:(NSString *)command completionHandler:(void(^ _Nonnull )(NSDictionary* _Nullable customFields,  NSArray* _Nullable updatedMultiValue, NSArray<CJMValidationResult*>* _Nullable errors))completion {
    ...
    CJMValidationResult *vr = [CJMValidator cleanMultiValuePropertyArray:multiValue forKey:key];
    // Check for an error
    if ([vr errorCode] != 0) {
        [errors addObject:vr];
        if ([vr errorDesc] != nil) {
