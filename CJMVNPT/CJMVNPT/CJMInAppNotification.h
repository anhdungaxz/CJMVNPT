...
#import "CJMNotificationButton.h"

@interface CJMInAppNotification : NSObject

@property (nonatomic, readonly) NSString *Id;
@property (nonatomic, readonly) NSString *campaignId;
@property (nonatomic, copy, readonly) NSString *type;
@property (nonatomic, readonly) CJMInAppType inAppType;
...
@property (nonatomic, readonly) NSArray<CJMNotificationButton *> *buttons;
