...
@interface CJMCoverViewController ()
...
@implementation CJMCoverViewController
...
- (void)loadView {
    [super loadView];
    [[CJMInAppUtils bundle] loadNibNamed:[CJMInAppUtils XibNameForControllerName:NSStringFromClass([CJMCoverViewController class])] owner:self options:nil];
}
