...
#import "CJMAVPlayerViewController.h"
...
@interface CJMInterstitialViewController ()
...
@property (nonatomic, strong) CJMAVPlayerViewController *playerController;

@end

@implementation CJMInterstitialViewController
...
- (void)loadView {
    [super loadView];
    [[CJMInAppUtils bundle] loadNibNamed:[CJMInAppUtils XibNameForControllerName:NSStringFromClass([CJMInterstitialViewController class])] owner:self options:nil];
}
...
- (void)layoutNotification {
    ...
    if (self.notification.mediaUrl) {
        self.playerController = [[CJMAVPlayerViewController alloc] initWithNotification:self.notification];
