...
@interface CJMHalfInterstitialViewController ()
...
@implementation CJMHalfInterstitialViewController
...
- (void)loadView {
    [super loadView];
    [[CJMInAppUtils bundle] loadNibNamed:[CJMInAppUtils XibNameForControllerName:NSStringFromClass([CJMHalfInterstitialViewController class])] owner:self options:nil];
}
