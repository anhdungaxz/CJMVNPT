...
typedef void (^CJMExperimentsUpdatedBlock)(void);

@interface CJM (ABTesting)
...
/*!
 ...
 @abstract
 Get whether the UIEditor connection to the CJM dashboard is enabled
 ...
 */
- (void)registerExperimentsUpdatedBlock:(CJMExperimentsUpdatedBlock _Nonnull)block;
