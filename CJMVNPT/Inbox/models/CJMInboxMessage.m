...
@interface CJMInboxMessageContent ()
- (instancetype) init __unavailable;
- (instancetype)initWithJSON:(NSDictionary *)json;
@end
#endif

@implementation CJMInboxMessage
...
- (instancetype)initWithJSON:(NSDictionary *)json {
    ...
    if (self) {
        ...
        for (NSDictionary *content in contents) {
            CJMInboxMessageContent *CJM_content = [[CJMInboxMessageContent alloc] initWithJSON:content];
            if (CJM_content) {
                [_contents addObject:CJM_content];
            }
        }
        _content = _contents;
