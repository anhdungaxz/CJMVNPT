...
@implementation CJMInboxMessageActionView
...
- (UIButton*)setupViewForButton:(UIButton *)buttonView forText:(NSDictionary *)messageButton withIndex:(int)index; {
    ...
    buttonView.backgroundColor = [CJMInAppUtils CJM_colorWithHexString:messageButton[@"bg"]];
    [buttonView setTitleColor:[CJMInAppUtils CJM_colorWithHexString:messageButton[@"color"]] forState:UIControlStateNormal];
    return buttonView;
}
