...
- (CGSize)swipeViewItemSize:(__unused CJMSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused CJMSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused CJMSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused CJMSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused CJMSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused CJMSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused CJMSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused CJMSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused CJMSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused CJMSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface CJMSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<CJMSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<CJMSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(CJMSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case CJMSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case CJMSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == CJMSwipeViewAlignmentCenter)
        {
