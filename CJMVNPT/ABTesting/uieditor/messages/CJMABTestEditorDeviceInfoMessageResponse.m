...
NSString *const CJMABTestEditorDeviceInfoMessageResponseType = @"device_info_response";

@implementation CJMABTestEditorDeviceInfoMessageResponse

+ (instancetype)message {
    return [[[self class] alloc] initWithType:CJMABTestEditorDeviceInfoMessageResponseType];
}
