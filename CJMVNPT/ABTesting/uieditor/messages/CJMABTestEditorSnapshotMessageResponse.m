...
NSString *const CJMABTestEditorSnapshotMessageResponseType = @"snapshot_response";

@implementation CJMABTestEditorSnapshotMessageResponse

+ (instancetype)message {
    return [[[self class] alloc] initWithType:CJMABTestEditorSnapshotMessageResponseType];
}
